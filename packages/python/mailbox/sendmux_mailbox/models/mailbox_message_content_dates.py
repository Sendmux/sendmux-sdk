...
class MailboxMessageContentDates(BaseModel):
    """
    MailboxMessageContentDates
    """ # noqa: E501
    received_at: Optional[StrictStr]
    sent_at: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["received_at", "sent_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MailboxMessageContentDates from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MailboxMessageContentDates from a dict"""
        if obj is None:
            return None
