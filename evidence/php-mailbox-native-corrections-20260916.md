...
- Worktree: sibling checkout `../sendmux-sdk-php-mailbox-native-corrections`.
...
- Explicit generator input: sibling checkout `../sendmux-docs-mcp-oauth`, HEAD `c5a6e1e3a1bab023f3051c12254e8dae069391f5`, containing snapshot commit `e4535b4`. Both snapshot bytes match this SDK base's `packages/python/mcp/sendmux_mcp/openapi/` files.
...
```sh
OPENAPI_INPUT_DIR=../sendmux-docs-mcp-oauth pnpm generate:php
```
