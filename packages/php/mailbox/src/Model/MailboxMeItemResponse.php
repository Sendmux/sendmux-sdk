...
/**
 * MailboxMeItemResponse Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxMeItemResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxMeItemResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Mailbox\Model\MailboxMe'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Mailbox\Model\MailboxMe
     */
    public function getData(): \Sendmux\Mailbox\Model\MailboxMe
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Mailbox\Model\MailboxMe $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Mailbox\Model\MailboxMe $data): static
    {
        if (is_null($data)) {
