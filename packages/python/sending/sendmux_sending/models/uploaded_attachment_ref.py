...
class UploadedAttachmentRef(BaseModel):
    ...
    """ # noqa: E501
    attachment_id: Annotated[str, Field(strict=True)] = Field(description="Temporary uploaded attachment ID returned by POST /emails/attachments.")
    __properties: ClassVar[List[str]] = ["attachment_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UploadedAttachmentRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UploadedAttachmentRef from a dict"""
        if obj is None:
            return None
