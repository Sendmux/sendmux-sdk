 ...
 */
class FilterRule implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'FilterRule';
     ...
     * Sets note
     *
     * @param string|null $note Free-form caption for the rule (≤255 chars). UI-only metadata — never consulted at match time. `null` when absent.
     *
     * @return $this
     */
    public function setNote(?string $note): static
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 255)) {
            throw new InvalidArgumentException('invalid length for $note when calling FilterRule., must be smaller than or equal to 255.');
        }
