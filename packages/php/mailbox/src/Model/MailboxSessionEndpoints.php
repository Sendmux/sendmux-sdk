...
/**
 * MailboxSessionEndpoints Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxSessionEndpoints implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxSession_endpoints';
     ...
     * @return $this
     */
    public function setMailbox(array $mailbox): static
    {
        if (is_null($mailbox)) {
