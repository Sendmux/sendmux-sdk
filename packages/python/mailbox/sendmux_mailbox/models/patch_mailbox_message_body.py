...
class PatchMailboxMessageBody(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["flagged", "keywords", "seen"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchMailboxMessageBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchMailboxMessageBody from a dict"""
        if obj is None:
            return None
