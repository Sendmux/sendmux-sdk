...
/**
 * MailboxMessageQueryChangesResponse Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxMessageQueryChangesResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxMessageQueryChangesResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Mailbox\Model\MailboxMessageQueryChanges'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Mailbox\Model\MailboxMessageQueryChanges
     */
    public function getData(): \Sendmux\Mailbox\Model\MailboxMessageQueryChanges
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Mailbox\Model\MailboxMessageQueryChanges $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Mailbox\Model\MailboxMessageQueryChanges $data): static
    {
        if (is_null($data)) {
