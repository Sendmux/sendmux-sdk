...
/**
 * IncomingLogItemResponse Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class IncomingLogItemResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'IncomingLogItemResponse';
     ...
     */
    public function getData(): \Sendmux\Management\Model\IncomingLogItem
    {
     ...
     * @return $this
     */
    public function setData(\Sendmux\Management\Model\IncomingLogItem $data): static
    {
        if (is_null($data)) {
