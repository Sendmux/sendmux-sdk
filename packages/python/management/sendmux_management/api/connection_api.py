...
class ConnectionApi:
    ...
    def management_get_connection(
        ...
        _param = self._management_get_connection_serialize(
    ...
    @validate_call
    def management_get_connection_with_http_info(
        self,
        if_none_match: Annotated[Optional[StrictStr], Field(description="ETag from a previous response. A match returns 304 with no body after rechecking authentication.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def management_get_connection_without_preload_content(
        self,
        if_none_match: Annotated[Optional[StrictStr], Field(description="ETag from a previous response. A match returns 304 with no body after rechecking authentication.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _management_get_connection_serialize(
        self,
        if_none_match,
        _request_auth,
        _content_type,
