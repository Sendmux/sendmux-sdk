...
class MailboxFiltersApi:
    ...
    @validate_call
    def management_get_mailbox_filters(
        self,
        public_id: StrictStr,
        ...
        _param = self._management_get_mailbox_filters_serialize(
            public_id=public_id,
    ...
    @validate_call
    def management_get_mailbox_filters_with_http_info(
        self,
        public_id: StrictStr,
        if_none_match: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def management_get_mailbox_filters_without_preload_content(
        self,
        public_id: StrictStr,
        if_none_match: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _management_get_mailbox_filters_serialize(
        self,
        public_id,
        if_none_match,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/mailboxes/{public_id}/filters',
    ...
    @validate_call
    def management_set_mailbox_filters(
        self,
        public_id: StrictStr,
        if_match: Optional[StrictStr] = None,
        set_filter_state_body: Optional[SetFilterStateBody] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param if_match:
        :type if_match: str
        :param set_filter_state_body:
        :type set_filter_state_body: SetFilterStateBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._management_set_mailbox_filters_serialize(
            public_id=public_id,
            if_match=if_match,
            set_filter_state_body=set_filter_state_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def management_set_mailbox_filters_with_http_info(
        self,
        public_id: StrictStr,
        if_match: Optional[StrictStr] = None,
        set_filter_state_body: Optional[SetFilterStateBody] = None,
    ...
    @validate_call
    def management_set_mailbox_filters_without_preload_content(
        self,
        public_id: StrictStr,
        if_match: Optional[StrictStr] = None,
        set_filter_state_body: Optional[SetFilterStateBody] = None,
    ...
    def _management_set_mailbox_filters_serialize(
        self,
        public_id,
        if_match,
        ...
        # process the form parameters
        # process the body parameter
        if set_filter_state_body is not None:
            _body_params = set_filter_state_body
