...
/**
 * ProviderQuotaRange Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProviderQuotaRange implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ProviderQuotaRange';
    ...
    public function setMax(int $max): static
    {
        ...
        if (($max <= 0)) {
            throw new InvalidArgumentException('invalid value for $max when calling ProviderQuotaRange., must be bigger than 0.');
        }
    ...
    public function setMin(int $min): static
    {
        ...
        if (($min <= 0)) {
            throw new InvalidArgumentException('invalid value for $min when calling ProviderQuotaRange., must be bigger than 0.');
        }
