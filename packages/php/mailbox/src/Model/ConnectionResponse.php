...
class ConnectionResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Mailbox\Model\Connection'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Mailbox\Model\Connection
     */
    public function getData(): \Sendmux\Mailbox\Model\Connection
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Mailbox\Model\Connection $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Mailbox\Model\Connection $data): static
    {
        if (is_null($data)) {
