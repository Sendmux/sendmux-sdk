...
/**
 * ProviderCreateBody Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProviderCreateBody implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ProviderCreateBody';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['smtp_protocol'] === null) {
            $invalidProperties[] = "'smtp_protocol' can't be null";
        }
    ...
    public function setFromEmail(?string $from_email): static
    {
        ...
        if (!is_null($from_email) && (mb_strlen($from_email) > 255)) {
            throw new InvalidArgumentException('invalid length for $from_email when calling ProviderCreateBody., must be smaller than or equal to 255.');
        }
    ...
    public function setFromName(?string $from_name): static
    {
        ...
        if (!is_null($from_name) && (mb_strlen($from_name) > 255)) {
            throw new InvalidArgumentException('invalid length for $from_name when calling ProviderCreateBody., must be smaller than or equal to 255.');
        }
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new InvalidArgumentException('invalid length for $name when calling ProviderCreateBody., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling ProviderCreateBody., must be bigger than or equal to 1.');
        }
    ...
    public function setPercentage(?int $percentage): static
    {
        ...
        if (($percentage > 100)) {
            throw new InvalidArgumentException('invalid value for $percentage when calling ProviderCreateBody., must be smaller than or equal to 100.');
        }
        if (($percentage < 0)) {
            throw new InvalidArgumentException('invalid value for $percentage when calling ProviderCreateBody., must be bigger than or equal to 0.');
        }
    ...
    public function setReplyToEmail(?string $reply_to_email): static
    {
        ...
        if (!is_null($reply_to_email) && (mb_strlen($reply_to_email) > 255)) {
            throw new InvalidArgumentException('invalid length for $reply_to_email when calling ProviderCreateBody., must be smaller than or equal to 255.');
        }
    ...
    public function setReplyToName(?string $reply_to_name): static
    {
        ...
        if (!is_null($reply_to_name) && (mb_strlen($reply_to_name) > 255)) {
            throw new InvalidArgumentException('invalid length for $reply_to_name when calling ProviderCreateBody., must be smaller than or equal to 255.');
        }
    ...
    public function setSmtpHost(string $smtp_host): static
    {
        ...
        if ((mb_strlen($smtp_host) > 255)) {
            throw new InvalidArgumentException('invalid length for $smtp_host when calling ProviderCreateBody., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($smtp_host) < 1)) {
            throw new InvalidArgumentException('invalid length for $smtp_host when calling ProviderCreateBody., must be bigger than or equal to 1.');
        }
    ...
    public function setSmtpPassword(string $smtp_password): static
    {
        ...
        if ((mb_strlen($smtp_password) > 500)) {
            throw new InvalidArgumentException('invalid length for $smtp_password when calling ProviderCreateBody., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($smtp_password) < 1)) {
            throw new InvalidArgumentException('invalid length for $smtp_password when calling ProviderCreateBody., must be bigger than or equal to 1.');
        }
    ...
    public function setSmtpPort(int $smtp_port): static
    {
        ...
        if (($smtp_port > 65535)) {
            throw new InvalidArgumentException('invalid value for $smtp_port when calling ProviderCreateBody., must be smaller than or equal to 65535.');
        }
        if (($smtp_port < 1)) {
            throw new InvalidArgumentException('invalid value for $smtp_port when calling ProviderCreateBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets smtp_protocol
     *
     * @param string $smtp_protocol smtp_protocol
     *
     * @return $this
     */
    ...
    public function setSmtpUsername(string $smtp_username): static
    {
        ...
        if ((mb_strlen($smtp_username) > 255)) {
            throw new InvalidArgumentException('invalid length for $smtp_username when calling ProviderCreateBody., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($smtp_username) < 1)) {
            throw new InvalidArgumentException('invalid length for $smtp_username when calling ProviderCreateBody., must be bigger than or equal to 1.');
        }
    ...
    public function setTrackingDomain(?string $tracking_domain): static
    {
        ...
        if (!is_null($tracking_domain) && (mb_strlen($tracking_domain) > 255)) {
            throw new InvalidArgumentException('invalid length for $tracking_domain when calling ProviderCreateBody., must be smaller than or equal to 255.');
        }
