...
def create_sending_client(
    *,
    ...
    validate_auth(api_key=api_key, access_token=access_token, surface="sending")
    ...
    return SendmuxSendingApiClient(configuration, access_token=access_token, retry_options=retry_options)
