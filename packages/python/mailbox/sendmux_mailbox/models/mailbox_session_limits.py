...
class MailboxSessionLimits(BaseModel):
    """
    MailboxSessionLimits
    """ # noqa: E501
    attachment_upload_bytes_max: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MailboxSessionLimits from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MailboxSessionLimits from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "attachment_upload_bytes_max": obj.get("attachment_upload_bytes_max"),
            ...
            "message_body_chars_default": obj.get("message_body_chars_default"),
            "outbound_raw_message_bytes_max": obj.get("outbound_raw_message_bytes_max"),
