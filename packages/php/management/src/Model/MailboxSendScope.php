...
/**
 * MailboxSendScope Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxSendScope implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxSendScope';
     ...
     *
     * @param string[]|null $group_public_ids Delivery group public IDs (only when type=group)
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $provider_public_ids Provider public IDs (only when type=providers)
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Outbound routing strategy. `all` lets the mailbox use any team-configured provider; `providers` restricts to the listed provider IDs; `group` routes via a delivery group.
     *
     * @return $this
     */
