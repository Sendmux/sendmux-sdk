 ...
 */
class FilterState implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'FilterState';
     ...
     * Sets mode
     *
     * @param string $mode Active filtering mode. `off` disables filtering (all senders accepted). `allowlist` only accepts senders matching a rule. `denylist` blocks senders matching a rule.
     *
     * @return $this
     */
     ...
     * Sets rules
     *
     * @param \Sendmux\Management\Model\FilterRule[] $rules Current rules, sorted by pattern ascending
     *
     * @return $this
     */
