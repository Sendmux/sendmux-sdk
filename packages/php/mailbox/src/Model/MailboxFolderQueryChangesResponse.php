...
/**
 * MailboxFolderQueryChangesResponse Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxFolderQueryChangesResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxFolderQueryChangesResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Mailbox\Model\MailboxFolderQueryChanges'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Mailbox\Model\MailboxFolderQueryChanges
     */
    public function getData(): \Sendmux\Mailbox\Model\MailboxFolderQueryChanges
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Mailbox\Model\MailboxFolderQueryChanges $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Mailbox\Model\MailboxFolderQueryChanges $data): static
    {
        if (is_null($data)) {
