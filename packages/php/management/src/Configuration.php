...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://app.sendmux.ai/api/v1';
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/2.1.1/PHP';
    ...
    {
        $report  = 'PHP SDK (Sendmux\Management) Debug Report:' . PHP_EOL;
