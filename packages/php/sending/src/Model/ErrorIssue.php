 ...
 */
class ErrorIssue implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ErrorIssue';
     ...
     * Sets code
     *
     * @param string $code Issue code from the validator
     *
     * @return $this
     */
     ...
     * Sets field
     *
     * @param string $field Dot-path to the failing field
     *
     * @return $this
     */
