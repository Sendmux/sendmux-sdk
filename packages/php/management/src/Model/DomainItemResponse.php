...
/**
 * DomainItemResponse Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DomainItemResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'DomainItemResponse';
     ...
     */
    public function getData(): \Sendmux\Management\Model\MailboxDomain
    {
     ...
     * @return $this
     */
    public function setData(\Sendmux\Management\Model\MailboxDomain $data): static
    {
        if (is_null($data)) {
