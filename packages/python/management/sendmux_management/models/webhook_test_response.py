...
class WebhookTestResponse(BaseModel):
    ...
    WebhookTestResponse
    """ # noqa: E501
    event_id: StrictStr = Field(description="The event_id attached to the X-Sendmux-Event-Id header of the test delivery.")
    __properties: ClassVar[List[str]] = ["event_id"]
