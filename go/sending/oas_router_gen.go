		...
		case '/': // Prefix: "/"
			...
			case 'm': // Prefix: "me"
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "GET":
						s.handleSendingGetConnectionRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, "GET")
					}
		...
		case '/': // Prefix: "/"
			...
			case 'm': // Prefix: "me"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "GET":
						r.name = SendingGetConnectionOperation
						r.summary = "Get Sending connection"
						r.operationID = "sendingGetConnection"
						r.pathPattern = "/me"
						r.args = args
						r.count = 0
						return r, true
