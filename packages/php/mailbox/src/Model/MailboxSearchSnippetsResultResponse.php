...
/**
 * MailboxSearchSnippetsResultResponse Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxSearchSnippetsResultResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxSearchSnippetsResultResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Mailbox\Model\MailboxSearchSnippetsResult'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Mailbox\Model\MailboxSearchSnippetsResult
     */
    public function getData(): \Sendmux\Mailbox\Model\MailboxSearchSnippetsResult
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Mailbox\Model\MailboxSearchSnippetsResult $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Mailbox\Model\MailboxSearchSnippetsResult $data): static
    {
        if (is_null($data)) {
