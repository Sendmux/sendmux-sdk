...
/**
 * SharedAmazonSesLimitRequestPage Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SharedAmazonSesLimitRequestPage implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'SharedAmazonSesLimitRequestPage';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['pending_request'] === null && !$this->isNullableSetToNull('pending_request')) {
            $invalidProperties[] = "'pending_request' is required";
        }
    ...
    public function setPendingRequest(?\Sendmux\Management\Model\SharedAmazonSesLimitRequest $pending_request): static
    {
        if (is_null($pending_request)) {
            ...
            $index = array_search('pending_request', $nullablesSetToNull);
            if ($index !== false) {
