...
/**
 * MailboxUsageResponse Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxUsageResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxUsageResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Mailbox\Model\MailboxUsage'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Mailbox\Model\MailboxUsage
     */
    public function getData(): \Sendmux\Mailbox\Model\MailboxUsage
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Mailbox\Model\MailboxUsage $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Mailbox\Model\MailboxUsage $data): static
    {
        if (is_null($data)) {
