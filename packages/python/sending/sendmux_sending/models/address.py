...
class Address(BaseModel):
    ...
    Sender address
    """ # noqa: E501
    email: Annotated[str, Field(strict=True, max_length=254)] = Field(description="Email address")
    name: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Display name")
