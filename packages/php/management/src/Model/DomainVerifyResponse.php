...
/**
 * DomainVerifyResponse Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DomainVerifyResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'DomainVerifyResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Management\Model\MailboxDomainVerifyResult'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Management\Model\MailboxDomainVerifyResult
     */
    public function getData(): \Sendmux\Management\Model\MailboxDomainVerifyResult
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Management\Model\MailboxDomainVerifyResult $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Management\Model\MailboxDomainVerifyResult $data): static
    {
        if (is_null($data)) {
