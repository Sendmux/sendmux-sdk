...
/**
 * MailboxSessionStates Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxSessionStates implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxSession_states';
     ...
     * @return $this
     */
    public function setFolders(string $folders): static
    {
        if (is_null($folders)) {
     ...
     * @return $this
     */
    public function setIdentities(string $identities): static
    {
     ...
     * Sets submissions
     *
     * @param string $submissions submissions
     *
     * @return $this
     */
    public function setSubmissions(string $submissions): static
    {
     ...
     * Sets threads
     *
     * @param string $threads threads
     *
     * @return $this
     */
    public function setThreads(string $threads): static
    {
        if (is_null($threads)) {
