 ...
 */
class BatchSummary implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BatchSummary';
     ...
     * @return $this
     */
    public function setQueued(int $queued): static
    {
        if (is_null($queued)) {
     ...
     * Sets total
     *
     * @param int $total Total messages in batch
     *
     * @return $this
     */
