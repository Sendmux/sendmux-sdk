...
/**
 * MailboxSendResultResponse Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxSendResultResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxSendResultResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Mailbox\Model\SendMailboxMessageResult'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Mailbox\Model\SendMailboxMessageResult
     */
    public function getData(): \Sendmux\Mailbox\Model\SendMailboxMessageResult
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Mailbox\Model\SendMailboxMessageResult $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Mailbox\Model\SendMailboxMessageResult $data): static
    {
        if (is_null($data)) {
