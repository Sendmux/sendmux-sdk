...
async def subscribe_resource(_ctx: Any, _params: mcp_types.SubscribeRequestParams) -> mcp_types.EmptyResult:
    return mcp_types.EmptyResult()


async def unsubscribe_resource(_ctx: Any, _params: mcp_types.UnsubscribeRequestParams) -> mcp_types.EmptyResult:
    return mcp_types.EmptyResult()


server._mcp_server.add_request_handler(
    "resources/subscribe",
    mcp_types.SubscribeRequestParams,
    subscribe_resource,
)
server._mcp_server.add_request_handler(
    "resources/unsubscribe",
    mcp_types.UnsubscribeRequestParams,
