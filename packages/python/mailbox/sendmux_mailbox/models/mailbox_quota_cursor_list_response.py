...
class MailboxQuotaCursorListResponse(BaseModel):
    """
    MailboxQuotaCursorListResponse
    """ # noqa: E501
    meta: ResponseMeta
    ok: StrictBool
    data: List[MailboxQuota]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MailboxQuotaCursorListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MailboxQuotaCursorListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ok": obj.get("ok"),
            "data": [MailboxQuota.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
