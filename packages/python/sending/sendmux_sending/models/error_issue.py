...
class ErrorIssue(BaseModel):
    ...
    ErrorIssue
    """ # noqa: E501
    code: StrictStr = Field(description="Issue code from the validator")
    var_field: StrictStr = Field(description="Dot-path to the failing field", alias="field")
    message: StrictStr = Field(description="Human-readable issue message")
