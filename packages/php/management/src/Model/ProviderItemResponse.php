...
/**
 * ProviderItemResponse Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProviderItemResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ProviderItemResponse';
     ...
     */
    public function getData(): \Sendmux\Management\Model\ProviderItem
    {
     ...
     * @return $this
     */
    public function setData(\Sendmux\Management\Model\ProviderItem $data): static
    {
        if (is_null($data)) {
