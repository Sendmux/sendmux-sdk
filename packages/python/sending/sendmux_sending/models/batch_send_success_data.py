...
class BatchSendSuccessData(BaseModel):
    """
    BatchSendSuccessData
    """ # noqa: E501
    results: List[BatchResultItem]
    summary: BatchSummary
    __properties: ClassVar[List[str]] = ["results", "summary"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchSendSuccessData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchSendSuccessData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "results": [BatchResultItem.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
