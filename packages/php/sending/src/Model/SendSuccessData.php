...
/**
 * SendSuccessData Class Doc Comment
 *
 * @package  Sendmux\Sending
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SendSuccessData implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'SendSuccessData';
     ...
     * Sets message_id
     *
     * @param string $message_id Unique message identifier (eml_ prefix + 24 alphanumeric chars)
     *
     * @return $this
     */
    public function setMessageId(string $message_id): static
    {
        ...
        if ((!preg_match("/^eml_[a-z0-9]{24}$/", ObjectSerializer::toString($message_id)))) {
            throw new InvalidArgumentException("invalid value for \$message_id when calling SendSuccessData., must conform to the pattern /^eml_[a-z0-9]{24}$/.");
        }
     ...
     * Sets status
     *
     * @param string $status Message queuing status
     *
     * @return $this
     */
