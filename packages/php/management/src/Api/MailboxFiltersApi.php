...
/**
 * MailboxFiltersApi Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class MailboxFiltersApi
{
    ...
    /**
     * Operation managementGetMailboxFilters
     *
     ...
     */
    public function managementGetMailboxFilters(
        string $public_id,
    ...
    /**
     * Operation managementGetMailboxFiltersWithHttpInfo
     *
     * Get mailbox sender filters
     *
     * @param  string $public_id public_id (required)
     ...
     */
    public function managementGetMailboxFiltersWithHttpInfo(
        string $public_id,
        ?string $if_none_match = null,
        string $contentType = self::contentTypes['managementGetMailboxFilters'][0]
    ): array {
    ...
    /**
     * Operation managementGetMailboxFiltersAsync
     *
     * Get mailbox sender filters
     *
     * @param  string $public_id public_id (required)
     ...
     */
    public function managementGetMailboxFiltersAsync(
        string $public_id,
        ?string $if_none_match = null,
        string $contentType = self::contentTypes['managementGetMailboxFilters'][0]
    ): PromiseInterface {
    ...
    /**
     * Operation managementGetMailboxFiltersAsyncWithHttpInfo
     *
     * Get mailbox sender filters
     *
     * @param  string $public_id public_id (required)
     ...
     * @return PromiseInterface
     */
    public function managementGetMailboxFiltersAsyncWithHttpInfo(
        string $public_id,
        ?string $if_none_match = null,
        string $contentType = self::contentTypes['managementGetMailboxFilters'][0]
    ): PromiseInterface {
     ...
     */
    public function managementGetMailboxFiltersRequest(
        string $public_id,
        ?string $if_none_match = null,
        string $contentType = self::contentTypes['managementGetMailboxFilters'][0]
    ): Request {
        ...
        if ($public_id === null || (is_array($public_id) && count($public_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $public_id when calling managementGetMailboxFilters'
            );
        }



        $resourcePath = '/mailboxes/{public_id}/filters';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation managementSetMailboxFilters
     *
     ...
     */
    public function managementSetMailboxFilters(
        string $public_id,
    ...
    /**
     * Operation managementSetMailboxFiltersWithHttpInfo
     *
     * Replace mailbox sender filters
     *
     * @param  string $public_id public_id (required)
    ...
    /**
     * Operation managementSetMailboxFiltersAsync
     *
     * Replace mailbox sender filters
     *
     * @param  string $public_id public_id (required)
     ...
     * @return PromiseInterface
     */
    public function managementSetMailboxFiltersAsync(
        string $public_id,
        ?string $if_match = null,
        ?\Sendmux\Management\Model\SetFilterStateBody $set_filter_state_body = null,
        string $contentType = self::contentTypes['managementSetMailboxFilters'][0]
    ...
    /**
     * Operation managementSetMailboxFiltersAsyncWithHttpInfo
     *
     * Replace mailbox sender filters
     *
     * @param  string $public_id public_id (required)
     ...
     * @return PromiseInterface
     */
    public function managementSetMailboxFiltersAsyncWithHttpInfo(
        string $public_id,
        ?string $if_match = null,
        ?\Sendmux\Management\Model\SetFilterStateBody $set_filter_state_body = null,
        string $contentType = self::contentTypes['managementSetMailboxFilters'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function managementSetMailboxFiltersRequest(
        string $public_id,
        ?string $if_match = null,
        ?\Sendmux\Management\Model\SetFilterStateBody $set_filter_state_body = null,
        string $contentType = self::contentTypes['managementSetMailboxFilters'][0]
        ...
        if ($public_id === null || (is_array($public_id) && count($public_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $public_id when calling managementSetMailboxFilters'
            );
        }
