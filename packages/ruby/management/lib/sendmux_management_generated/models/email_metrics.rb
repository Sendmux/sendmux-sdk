...
module Sendmux::Management::Generated
  class EmailMetrics < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'timeseries' => :'Array<EmailMetricsTimeseriesInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Sendmux::Management::Generated::EmailMetrics` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Sendmux::Management::Generated::EmailMetrics`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] timeseries Value to be assigned
    def timeseries=(timeseries)
      if timeseries.nil?
        fail ArgumentError, 'timeseries cannot be nil'
      end
    ...
    def hash
      [comparison, summary, timeseries].hash
    end
