...
class ProviderAllowedActions(BaseModel):
    """
    ProviderAllowedActions
    """ # noqa: E501
    activate: StrictBool
    deactivate: StrictBool
    delete: StrictBool
    test: StrictBool
    update: StrictBool
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProviderAllowedActions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProviderAllowedActions from a dict"""
        if obj is None:
            return None
