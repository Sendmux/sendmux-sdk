...
class Balance(BaseModel):
    ...
    currency: StrictStr
    __properties: ClassVar[List[str]] = ["auto_topup", "balance", "balance_consumed", "balance_purchased", "currency"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of auto_topup
        if self.auto_topup:
            _dict['auto_topup'] = self.auto_topup.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "auto_topup": BalanceAutoTopup.from_dict(obj["auto_topup"]) if obj.get("auto_topup") is not None else None,
            "balance": obj.get("balance"),
            "balance_consumed": obj.get("balance_consumed"),
            "balance_purchased": obj.get("balance_purchased"),
