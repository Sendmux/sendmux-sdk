...
/**
 * ProviderQuotas Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProviderQuotas implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ProviderQuotas';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['per_day'] === null && !$this->isNullableSetToNull('per_day')) {
            $invalidProperties[] = "'per_day' is required";
        }
        if ($this->container['per_hour'] === null && !$this->isNullableSetToNull('per_hour')) {
            $invalidProperties[] = "'per_hour' is required";
        }
        if ($this->container['per_minute'] === null && !$this->isNullableSetToNull('per_minute')) {
            $invalidProperties[] = "'per_minute' is required";
        }
        if ($this->container['per_second'] === null && !$this->isNullableSetToNull('per_second')) {
            $invalidProperties[] = "'per_second' is required";
        }
    ...
    public function setPerHour(?\Sendmux\Management\Model\ProviderQuotaRange $per_hour): static
    {
        if (is_null($per_hour)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('per_hour', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setPerMinute(?\Sendmux\Management\Model\ProviderQuotaRange $per_minute): static
    {
        if (is_null($per_minute)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('per_minute', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setPerSecond(?\Sendmux\Management\Model\ProviderQuotaRange $per_second): static
    {
        if (is_null($per_second)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('per_second', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
