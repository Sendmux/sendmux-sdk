...
require_relative 'lib/sendmux/sending/version'

Gem::Specification.new do |spec|
  spec.name = 'sendmux-sending'
  spec.version = Sendmux::Sending::VERSION
  spec.authors = ['Sendmux']
  spec.email = ['contact@sendmux.ai']
  spec.summary = 'Ruby SDK for the Sendmux Sending API.'
