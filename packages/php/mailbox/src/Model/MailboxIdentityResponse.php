...
/**
 * MailboxIdentityResponse Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxIdentityResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxIdentityResponse';
     ...
     * Gets data
     *
     * @return \Sendmux\Mailbox\Model\MailboxIdentity
     */
    public function getData(): \Sendmux\Mailbox\Model\MailboxIdentity
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Mailbox\Model\MailboxIdentity $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Mailbox\Model\MailboxIdentity $data): static
    {
        if (is_null($data)) {
