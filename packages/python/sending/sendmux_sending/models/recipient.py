...
class Recipient(BaseModel):
    ...
    Recipient
    """ # noqa: E501
    email: Annotated[str, Field(strict=True, max_length=254)] = Field(description="Recipient email address")
    name: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Recipient display name")
