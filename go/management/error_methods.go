...
// APIError maps ManagementVerifyDomainConflict into the shared typed API error.
func (r *ManagementVerifyDomainConflict) APIError() *core.APIError {
	err, _ := core.APIErrorFromResponse(&r.Response, 409)
	return err
}

// APIError maps ManagementVerifyDomainInternalServerError into the shared typed API error.
func (r *ManagementVerifyDomainInternalServerError) APIError() *core.APIError {
	err, _ := core.APIErrorFromResponse(&r.Response, 500)
	return err
}

// APIError maps ManagementVerifyDomainNotFound into the shared typed API error.
func (r *ManagementVerifyDomainNotFound) APIError() *core.APIError {
	err, _ := core.APIErrorFromResponse(&r.Response, 404)
	return err
}

// APIError maps ManagementVerifyDomainServiceUnavailable into the shared typed API error.
func (r *ManagementVerifyDomainServiceUnavailable) APIError() *core.APIError {
	err, _ := core.APIErrorFromResponse(&r.Response, 503)
	return err
}
