...
/**
 * MailboxSessionResponse Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxSessionResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxSessionResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Mailbox\Model\MailboxSession'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Mailbox\Model\MailboxSession
     */
    public function getData(): \Sendmux\Mailbox\Model\MailboxSession
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Mailbox\Model\MailboxSession $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Mailbox\Model\MailboxSession $data): static
    {
        if (is_null($data)) {
