...
module Sendmux::Management::Generated
  class EmailMetricsComparison < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Sendmux::Management::Generated::EmailMetricsComparison` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Sendmux::Management::Generated::EmailMetricsComparison`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] change_pct Value to be assigned
    def change_pct=(change_pct)
      if change_pct.nil?
        fail ArgumentError, 'change_pct cannot be nil'
      end
    ...
    def hash
      [change_pct, failed, pending, rejected, sent, total].hash
    end
