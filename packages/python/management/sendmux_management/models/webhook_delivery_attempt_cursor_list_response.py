...
class WebhookDeliveryAttemptCursorListResponse(BaseModel):
    """
    WebhookDeliveryAttemptCursorListResponse
    """ # noqa: E501
    meta: ResponseMeta
    ok: StrictBool
    data: List[WebhookDeliveryAttempt]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookDeliveryAttemptCursorListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookDeliveryAttemptCursorListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ok": obj.get("ok"),
            "data": [WebhookDeliveryAttempt.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
