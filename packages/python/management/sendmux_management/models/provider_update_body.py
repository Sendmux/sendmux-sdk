...
class ProviderUpdateBody(BaseModel):
    ...
    smtp_host: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = None
    smtp_password: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=500)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProviderUpdateBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProviderUpdateBody from a dict"""
        if obj is None:
            return None
