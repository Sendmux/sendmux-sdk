...
class MailboxThreadContentMeta(BaseModel):
    """
    ...
    thread_id: StrictStr
    __properties: ClassVar[List[str]] = ["participants", "request_id", "states", "thread_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MailboxThreadContentMeta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MailboxThreadContentMeta from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "states": MailboxThreadContentMetaStates.from_dict(obj["states"]) if obj.get("states") is not None else None,
