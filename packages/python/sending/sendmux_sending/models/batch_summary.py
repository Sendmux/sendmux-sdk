...
class BatchSummary(BaseModel):
    ...
    BatchSummary
    """ # noqa: E501
    failed: StrictInt = Field(description="Failed count")
    queued: StrictInt = Field(description="Successfully queued count")
    total: StrictInt = Field(description="Total messages in batch")
    __properties: ClassVar[List[str]] = ["failed", "queued", "total"]
