...
def create_management_client(
    *,
    ...
    validate_auth(api_key=api_key, access_token=access_token, surface="root")
    ...
    return SendmuxManagementApiClient(configuration, access_token=access_token, retry_options=retry_options)
