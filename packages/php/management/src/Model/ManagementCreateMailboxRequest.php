...
/**
 * ManagementCreateMailboxRequest Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ManagementCreateMailboxRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'managementCreateMailbox_request';
    ...
    public function setDisplayName(?string $display_name): static
    {
        ...
        if ((mb_strlen($display_name) > 254)) {
            throw new InvalidArgumentException('invalid length for $display_name when calling ManagementCreateMailboxRequest., must be smaller than or equal to 254.');
        }
        if ((mb_strlen($display_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $display_name when calling ManagementCreateMailboxRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail(string $email): static
    {
        ...
        if ((mb_strlen($email) > 254)) {
            throw new InvalidArgumentException('invalid length for $email when calling ManagementCreateMailboxRequest., must be smaller than or equal to 254.');
        }
    ...
    public function setQuotaBytes(?int $quota_bytes): static
    {
        ...
        if (($quota_bytes < 1)) {
            throw new InvalidArgumentException('invalid value for $quota_bytes when calling ManagementCreateMailboxRequest., must be bigger than or equal to 1.');
        }
