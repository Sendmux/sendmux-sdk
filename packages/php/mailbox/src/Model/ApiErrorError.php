...
class ApiErrorError implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'code' => 'string',
        'doc_url' => 'string',
        'errors' => '\Sendmux\Mailbox\Model\ApiErrorDetail[]',
        'message' => 'string',
        'param' => 'string',
        'retryable' => 'bool'
    ];
     ...
     * Gets errors
     *
     * @return \Sendmux\Mailbox\Model\ApiErrorDetail[]|null
     */
     ...
     * Sets errors
     *
     * @param \Sendmux\Mailbox\Model\ApiErrorDetail[]|null $errors Accumulated per-field issues for validation errors. Only present on 400/422 responses.
     *
     * @return $this
     */
