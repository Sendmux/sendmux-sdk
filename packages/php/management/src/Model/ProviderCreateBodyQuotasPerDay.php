...
/**
 * ProviderCreateBodyQuotasPerDay Class Doc Comment
 *
 * @description Quota value. Use a number for a fixed cap, a min/max range, or null to clear on PATCH.
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class ProviderCreateBodyQuotasPerDay implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ProviderCreateBody_quotas_per_day';
    ...
    public function setMax(int $max): static
    {
        ...
        if (($max <= 0)) {
            throw new InvalidArgumentException('invalid value for $max when calling ProviderCreateBodyQuotasPerDay., must be bigger than 0.');
        }
    ...
    public function setMin(int $min): static
    {
        ...
        if (($min <= 0)) {
            throw new InvalidArgumentException('invalid value for $min when calling ProviderCreateBodyQuotasPerDay., must be bigger than 0.');
        }
