...
/**
 * MailboxGetChanges200Response Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxGetChanges200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'mailboxGetChanges_200_response';
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Mailbox\Model\MailboxTypedChanges'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Mailbox\Model\MailboxTypedChanges
     */
    public function getData(): \Sendmux\Mailbox\Model\MailboxTypedChanges
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Mailbox\Model\MailboxTypedChanges $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Mailbox\Model\MailboxTypedChanges $data): static
    {
        if (is_null($data)) {
