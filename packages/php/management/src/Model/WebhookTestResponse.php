...
class WebhookTestResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'WebhookTestResponse';
     ...
     * Sets event_id
     *
     * @param string $event_id The event_id attached to the X-Sendmux-Event-Id header of the test delivery.
     *
     * @return $this
     */
