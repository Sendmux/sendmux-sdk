...
/**
 * MailboxThreadContentMeta Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxThreadContentMeta implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxThreadContentMeta';
    ...
    protected static array $openAPITypes = [
        ...
        'request_id' => 'string',
        'states' => '\Sendmux\Mailbox\Model\MailboxThreadContentMetaStates',
        'thread_id' => 'string'
    ];
     ...
     * Gets states
     *
     * @return \Sendmux\Mailbox\Model\MailboxThreadContentMetaStates
     */
    public function getStates(): \Sendmux\Mailbox\Model\MailboxThreadContentMetaStates
    {
     ...
     * Sets states
     *
     * @param \Sendmux\Mailbox\Model\MailboxThreadContentMetaStates $states states
     *
     * @return $this
     */
    public function setStates(\Sendmux\Mailbox\Model\MailboxThreadContentMetaStates $states): static
    {
        if (is_null($states)) {
