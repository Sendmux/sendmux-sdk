...
/**
 * MailboxItemResponse Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxItemResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxItemResponse';
     ...
     */
    public function getData(): \Sendmux\Management\Model\Mailbox
    {
     ...
     * @return $this
     */
    public function setData(\Sendmux\Management\Model\Mailbox $data): static
    {
        if (is_null($data)) {
