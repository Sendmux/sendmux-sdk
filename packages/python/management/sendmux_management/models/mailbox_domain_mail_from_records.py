...
class MailboxDomainMailFromRecords(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MailboxDomainMailFromRecords from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MailboxDomainMailFromRecords from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mx": MailboxDomainNamedMxRecord.from_dict(obj["mx"]) if obj.get("mx") is not None else None,
