...
class WebhookSubscriptionResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'WebhookSubscriptionResponse';
     ...
     */
    public function getData(): \Sendmux\Management\Model\WebhookSubscription
    {
     ...
     * @return $this
     */
    public function setData(\Sendmux\Management\Model\WebhookSubscription $data): static
    {
        if (is_null($data)) {
