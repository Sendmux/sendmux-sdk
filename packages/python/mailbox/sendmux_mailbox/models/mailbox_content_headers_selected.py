...
class MailboxContentHeadersSelected(BaseModel):
    """
    MailboxContentHeadersSelected
    """ # noqa: E501
    in_reply_to: Optional[StrictStr]
    message_id: List[StrictStr]
    references: List[StrictStr]
    reply_to: List[MailboxAddress]
    __properties: ClassVar[List[str]] = ["in_reply_to", "message_id", "references", "reply_to"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MailboxContentHeadersSelected from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MailboxContentHeadersSelected from a dict"""
        if obj is None:
            return None
