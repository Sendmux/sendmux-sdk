...
/**
 * MailboxAttachmentUploadResultResponse Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxAttachmentUploadResultResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxAttachmentUploadResultResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Mailbox\Model\MailboxAttachmentUploadResult'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Mailbox\Model\MailboxAttachmentUploadResult
     */
    public function getData(): \Sendmux\Mailbox\Model\MailboxAttachmentUploadResult
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Mailbox\Model\MailboxAttachmentUploadResult $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Mailbox\Model\MailboxAttachmentUploadResult $data): static
    {
        if (is_null($data)) {
