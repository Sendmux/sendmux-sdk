...
class DomainItemCursorListResponse(BaseModel):
    """
    DomainItemCursorListResponse
    """ # noqa: E501
    meta: ResponseMeta
    ok: StrictBool
    data: List[MailboxDomain]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DomainItemCursorListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DomainItemCursorListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ok": obj.get("ok"),
            "data": [MailboxDomain.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
