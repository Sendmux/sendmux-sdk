...
// import a surface package such as sendmux.ai/go/v2/sending, sendmux.ai/go/v2/mailbox,
// or sendmux.ai/go/v2/management; those packages apply the core helpers for you.
package core
