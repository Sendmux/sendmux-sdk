...
module Sendmux::Mailbox::Generated
  class MailboxRealtimeMessageAllOfBody < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if @max_bytes.nil?
        invalid_properties.push('invalid value for "max_bytes", max_bytes cannot be nil.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] max_bytes Value to be assigned
    def max_bytes=(max_bytes)
      if max_bytes.nil?
        fail ArgumentError, 'max_bytes cannot be nil'
      end
    ...
    def hash
      [html, is_truncated, max_bytes, text].hash
    end
