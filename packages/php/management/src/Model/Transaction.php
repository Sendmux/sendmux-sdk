...
class Transaction implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['balance_after'] === null && !$this->isNullableSetToNull('balance_after')) {
            $invalidProperties[] = "'balance_after' is required";
        }
        if ($this->container['balance_before'] === null && !$this->isNullableSetToNull('balance_before')) {
            $invalidProperties[] = "'balance_before' is required";
        }
     ...
     * Sets amount
     *
     * @param string $amount DECIMAL(19,6) amount
     *
     * @return $this
     */
     ...
     * Sets balance_after
     *
     * @param string|null $balance_after balance_after
     *
     * @return $this
     */
    public function setBalanceAfter(?string $balance_after): static
    {
     ...
     * Sets balance_before
     *
     * @param string|null $balance_before balance_before
     *
     * @return $this
     */
    public function setBalanceBefore(?string $balance_before): static
    {
     ...
     * Sets id
     *
     * @param string $id Transaction public ID
     *
     * @return $this
     */
     ...
     * Sets quantity
     *
     * @param float|null $quantity Item count (for USAGE transactions)
     *
     * @return $this
     */
