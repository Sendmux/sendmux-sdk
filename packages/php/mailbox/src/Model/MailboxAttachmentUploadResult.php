...
/**
 * MailboxAttachmentUploadResult Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxAttachmentUploadResult implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxAttachmentUploadResult';
     ...
     * Sets blob_id
     *
     * @param string $blob_id Uploaded attachment blob ID for a later send request.
     *
     * @return $this
     */
