...
/**
 * MailboxThreadDetailResponse Class Doc Comment
 *
 * @package  Sendmux\Mailbox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MailboxThreadDetailResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MailboxThreadDetailResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Mailbox\Model\MailboxThread'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Mailbox\Model\MailboxThread
     */
    public function getData(): \Sendmux\Mailbox\Model\MailboxThread
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Mailbox\Model\MailboxThread $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Mailbox\Model\MailboxThread $data): static
    {
        if (is_null($data)) {
