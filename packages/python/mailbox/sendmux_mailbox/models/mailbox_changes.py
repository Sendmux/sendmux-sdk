...
class MailboxChanges(BaseModel):
    """
    MailboxChanges
    """ # noqa: E501
    created: List[StrictStr]
    destroyed: List[StrictStr]
    has_more: StrictBool
    new_state: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MailboxChanges from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MailboxChanges from a dict"""
        if obj is None:
            return None
