...
class Recipient implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['name']) && !preg_match("/^[^\\r\\n]*$/", $this->container['name'])) {
    ...
    public function setEmail(string $email): static
    {
        ...
        if ((mb_strlen($email) > 254)) {
            throw new InvalidArgumentException('invalid length for $email when calling Recipient., must be smaller than or equal to 254.');
        }
    ...
    public function setName(?string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling Recipient., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/^[^\\r\\n]*$/", ObjectSerializer::toString($name)))) {
            throw new InvalidArgumentException("invalid value for \$name when calling Recipient., must conform to the pattern /^[^\\r\\n]*$/.");
        }
