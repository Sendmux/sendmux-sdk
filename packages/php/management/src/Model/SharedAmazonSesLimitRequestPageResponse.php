...
/**
 * SharedAmazonSesLimitRequestPageResponse Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SharedAmazonSesLimitRequestPageResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'SharedAmazonSesLimitRequestPageResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'ok' => 'bool',
        'data' => '\Sendmux\Management\Model\SharedAmazonSesLimitRequestPage'
    ];
     ...
     * Gets data
     *
     * @return \Sendmux\Management\Model\SharedAmazonSesLimitRequestPage
     */
    public function getData(): \Sendmux\Management\Model\SharedAmazonSesLimitRequestPage
    {
     ...
     * Sets data
     *
     * @param \Sendmux\Management\Model\SharedAmazonSesLimitRequestPage $data data
     *
     * @return $this
     */
    public function setData(\Sendmux\Management\Model\SharedAmazonSesLimitRequestPage $data): static
    {
        if (is_null($data)) {
