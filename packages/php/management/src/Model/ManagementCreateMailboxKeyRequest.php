...
/**
 * ManagementCreateMailboxKeyRequest Class Doc Comment
 *
 * @package  Sendmux\Management
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ManagementCreateMailboxKeyRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'managementCreateMailboxKey_request';
    ...
    public function setAppName(string $app_name): static
    {
        ...
        if ((mb_strlen($app_name) > 255)) {
            throw new InvalidArgumentException('invalid length for $app_name when calling ManagementCreateMailboxKeyRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($app_name) < 1)) {
            throw new InvalidArgumentException('invalid length for $app_name when calling ManagementCreateMailboxKeyRequest., must be bigger than or equal to 1.');
        }
